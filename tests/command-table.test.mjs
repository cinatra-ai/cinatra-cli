  ...
  it("pins the full descriptor surface (id, command, match, hidden)", () => {
    ...
    expect(shape).toMatchInlineSnapshot(`
      [
        ...
        {
          "command": "instance preview create",
          "hidden": false,
          "id": "preview.create",
          "match": "command+mode+sub",
        },
        {
          "command": "instance preview refresh",
          "hidden": false,
          "id": "preview.refresh",
          "match": "command+mode+sub",
        },
        ...
        {
          "command": "instance preview list",
          "hidden": false,
          "id": "preview.list",
          "match": "command+mode+sub",
        },
        {
          "command": "instance execution set-mode",
          "hidden": false,
          "id": "execution.set-mode",
          "match": "command+mode+sub",
        },
        {
          "command": "instance execution doctor",
          "hidden": false,
          "id": "execution.doctor",
          "match": "command+mode+sub",
        },
        {
          "command": "instance execution status",
          "hidden": false,
          "id": "execution.status",
          "match": "command+mode+sub",
        },
        {
          "command": "instance execution pull",
          "hidden": false,
          "id": "execution.pull",
          "match": "command+mode+sub",
        },
        {
          "command": "instance execution verify",
          "hidden": false,
          "id": "execution.verify",
          "match": "command+mode+sub",
        },
        {
          "command": "instance execution prune",
          "hidden": false,
          "id": "execution.prune",
          "match": "command+mode+sub",
        },
        {
          "command": "instance execution gc",
          "hidden": false,
          "id": "execution.gc",
          "match": "command+mode+sub",
        },
...
describe("command table — routing (longest-match)", () => {
  const cases = [
    ...
    [["instance", "preview", "create"], "preview.create"],
    [["instance", "preview", "create", "--ref", "main"], "preview.create"],
    [["instance", "preview", "refresh"], "preview.refresh"],
    [["instance", "preview", "status"], "preview.status"],
    [["instance", "preview", "list"], "preview.list"],
